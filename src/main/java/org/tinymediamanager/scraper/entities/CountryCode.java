 ...
 * 
 * <p>
 * Enum names of this enum themselves are represented by <a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2">ISO 3166-1 alpha-2</a> codes. There
 * are instance methods to get the country name ({@link #getName()} ), the <a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-3" >ISO 3166-1
 * alpha-3</a> code ({@link #getAlpha3()}) and the <a href="http://en.wikipedia.org/wiki/ISO_3166-1_numeric">ISO 3166-1 numeric</a> code (
...
public enum CountryCode {
  ...
  //
  // /**
  // * <a href="http://en.wikipedia.org/wiki/Antigua_and_Barbuda">Antigua and
  // * Barbuda</a>
  // */
  ...
  //
  // /**
  // * <a href="http://en.wikipedia.org/wiki/Netherlands_Antilles">Netherlands
  // * Antilles</a>
  // */
  ...
  AR("Argentina", "ARG", 32),
  //
  // /** <a href="http://en.wikipedia.org/wiki/American_Samoa">American
  // Samoa</a> */
  ...
  //
  // /**
  // * <a href="http://en.wikipedia.org/wiki/%C3%85land_Islands">&Aring;land
  // * Islands</a>
  // */
  ...
  //
  // /**
  // * <a href="http://en.wikipedia.org/wiki/Bosnia_and_Herzegovina">Bosnia and
  // * Herzegovina</a>
  // */
  ...
  //
  // /**
  // * <a href="http://en.wikipedia.org/wiki/Saint_Barth%C3%A9lemy">Saint
  // * Barth&eacute;lemy</a>
  // */
  ...
  //
  // /**
  // * <a href="http://en.wikipedia.org/wiki/Bolivia">Plurinational State of
  // * Bolivia</a>
  // */
  // BO("Plurinational State of Bolivia", "BOL", 68),
  //
  // /**
  // * <a href="http://en.wikipedia.org/wiki/Caribbean_Netherlands">Bonaire,
  // Sint
  ...
  //
  // /**
  // * <a href="http://en.wikipedia.org/wiki/Cocos_(Keeling)_Islands">Cocos
  // * (Keeling) Islands</a>
  // */
  ...
  // /**
  // * <a
  // href="http://en.wikipedia.org/wiki/Democratic_Republic_of_the_Congo">The
  // * Democratic Republic of the Congo</a>
  // */
  // CD("The Democratic Republic of the Congo", "COD", 180),
  //
  // /**
  // * <a href="http://en.wikipedia.org/wiki/Central_African_Republic">Central
  // * African Republic</a>
  // */
  ...
  //
  // /**
  // * <a href="http://en.wikipedia.org/wiki/C%C3%B4te_d%27Ivoire">C&ocirc;te
  // * d'Ivoire</a>
  // */
  ...
  //
  // /**
  // * <a href="http://en.wikipedia.org/wiki/Christmas_Island">Christmas
  // * Island</a>
  // */
  ...
  //
  // /**
  // * <a href="http://en.wikipedia.org/wiki/Dominican_Republic">Dominican
  // * Republic</a>
  // */
  ...
  EG("Egypt", "EGY", 818),
  //
  // /** <a href="http://en.wikipedia.org/wiki/Western_Sahara">Western
  // Sahara</a> */
  ...
  //
  // /**
  // * <a href="http://en.wikipedia.org/wiki/Falkland_Islands">Falkland Islands
  // * (Malvinas)</a>
  // */
  // FK("Falkland Islands", "FLK", 238),
  //
  // /**
  // * <a href="http://en.wikipedia.org/wiki/Federated_States_of_Micronesia">
  ...
  //
  // /**
  // * <a href="http://en.wikipedia.org/wiki/Equatorial_Guinea">Equatorial
  // * Guinea</a>
  // */
  ...
  IQ("Iraq", "IRQ", 368),
  //
  // /** <a href="http://en.wikipedia.org/wiki/Iran">Islamic Republic of
  // Iran</a> */
  ...
  //
  // /**
  // * <a href="http://en.wikipedia.org/wiki/Saint_Kitts_and_Nevis">Saint Kitts
  // * and Nevis</a>
  // */
  // KN("Saint Kitts and Nevis", "KNA", 659),
  //
  // /**
  // * <a href="http://en.wikipedia.org/wiki/North_Korea">Democratic People's
  // * Republic of Korea</a>
  // */
  ...
  //
  // /**
  // * <a href="http://en.wikipedia.org/wiki/Laos">Lao People's Democratic
  // * Republic</a>
  // */
  ...
  //
  // /**
  // * <a href="http://en.wikipedia.org/wiki/Collectivity_of_Saint_Martin">Saint
  // * Martin (French part)</a>
  // */
  ...
  //
  // /**
  // * <a href="http://en.wikipedia.org/wiki/Marshall_Islands">Marshall
  // * Islands</a>
  // */
  ...
  // NE("Niger", "NER", 562),
  //
  // /** <a href="http://en.wikipedia.org/wiki/Norfolk_Island">Norfolk
  // Island</a> */
  ...
  //
  // /**
  // * <a href="http://en.wikipedia.org/wiki/French_Polynesia">French
  // * Polynesia</a>
  // */
  ...
  //
  // /**
  // * <a href="http://en.wikipedia.org/wiki/Saint_Pierre_and_Miquelon">Saint
  // * Pierre and Miquelon</a>
  // */
  ...
  //
  // /** <a href="http://en.wikipedia.org/wiki/Solomon_Islands">Solomon
  // Islands</a> */
  ...
  //
  // /**
  // * <a href="http://en.wikipedia.org/wiki/Svalbard_and_Jan_Mayen">Svalbard
  // and
  // * Jan Mayen</a>
  // */
  ...
  //
  // /**
  // * <a href="http://en.wikipedia.org/wiki/Sint_Maarten">Sint Maarten (Dutch
  // * part)</a>
  // */
  ...
  //
  // /**
  // * <a href="http://en.wikipedia.org/wiki/Turks_and_Caicos_Islands">Turks and
  // * Caicos Islands</a>
  // */
  ...
  //
  // /**
  // * <a href="http://en.wikipedia.org/wiki/Trinidad_and_Tobago">Trinidad and
  // * Tobago</a>
  // */
  ...
  //
  // /**
  // * <a href="http://en.wikipedia.org/wiki/Tanzania">United Republic of
  // * Tanzania</a>
  // */
  ...
  //
  // /**
  // * <a href="http://en.wikipedia.org/wiki/Vatican_City">Holy See (Vatican
  // City
  // * State)</a>
  // */
  // VA("Holy See", "VAT", 336),
  //
  // /**
  // * <a href="http://en.wikipedia.org/wiki/Saint_Vincent_and_the_Grenadines">
  ...
  //
  // /**
  // * <a href="http://en.wikipedia.org/wiki/British_Virgin_Islands">British
  // * Virgin Islands</a>
  // */
  ...
  //
  // /**
  // * <a href="http://en.wikipedia.org/wiki/Wallis_and_Futuna">Wallis and
  // * Futuna</a>
  // */
  ...
  /**
   * Get a CountryCode that corresponds to a given <a href="http://en.wikipedia.org/wiki/ISO_3166-1_numeric">ISO 3166-1 numeric</a> code.
   * 
   * @param code
   *          An <a href="http://en.wikipedia.org/wiki/ISO_3166-1_numeric" >ISO 3166-1 numeric</a> code.
   * 
   * @return A CountryCode instance, or null if not found.
   */
