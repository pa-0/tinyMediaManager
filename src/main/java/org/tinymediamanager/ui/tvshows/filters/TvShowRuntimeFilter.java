...
/**
 * the class {@link TvShowRuntimeFilter} provides a filter for the episode runtime
 * 
 * @author Manuel Laggner
 */
public class TvShowRuntimeFilter extends AbstractNumberTvShowUIFilter {
  public TvShowRuntimeFilter() {
    super();
  ...
  protected boolean accept(TvShow tvShow, List<TvShowEpisode> episodes, boolean invert) {
    try {
      ...
      for (TvShowEpisode episode : episodes) {
        boolean foundEpisode = matchInt(episode.getRuntimeFromMediaFilesInMinutes());
