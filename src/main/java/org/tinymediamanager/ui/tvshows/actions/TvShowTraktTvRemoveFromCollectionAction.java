...
/**
 * The class {@link TvShowSyncSelectedTraktTvAction}. To synchronize selected TV shows with trakt.tv (collection + watched)
 * 
 * @author Myron Boyle
 */
public class TvShowTraktTvRemoveFromCollectionAction extends TmmAction {
  public TvShowTraktTvRemoveFromCollectionAction() {
    putValue(NAME, TmmResourceBundle.getString("tvshow.synctrakt.selected.collection.remove"));
  ...
  protected void processAction(ActionEvent e) {
    ...
    task.setRemoveFromCollection(true);
