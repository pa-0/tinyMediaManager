 ...
 */
public class MovieDiscArtSizeFilter extends AbstractNumberMovieFilter {

  public MovieDiscArtSizeFilter() {
    super();
  ...
  @Override
  public String getId() {
    return "movieDiscArtSize";
  }

  @Override
  public boolean accept(Movie movie) {
    return matchInt(movie.getArtworkDimension(MediaFileType.DISC).width);
  }
