...
/**
 * this class is used for a movie poster size filter
 * 
 * @author Manuel Laggner
 */
public class MoviePosterSizeFilter extends AbstractNumberMovieFilter {
  ...
  public boolean accept(Movie movie) {
    return matchInt(movie.getArtworkDimension(MediaFileType.POSTER).height);
  }
